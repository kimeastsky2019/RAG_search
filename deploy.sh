...
SERVER="metal@test.gngmeta.com"
PEM_KEY="/Users/donghokim/Documents/AI_Agent/NanoGrid/energy-orchestrator-platform.pem"
...
if [ $? -eq 0 ]; then
    echo ""
    echo "✅ 배포 완료!"
    echo "📍 접속 URL: https://test.gngmeta.com/oag/"
    echo ""
